        ...
        <a href="<?php echo the_permalink()?>" class="article-grid-permalink">
          ...
          <div class="article-grid-info">
            <div class="author">
              ...
              <span class="author-name"><strong class="">
                  <?php the_author(); ?>
                </strong>:
            ...
            <div class="comments">
              <img src="<?php echo get_template_directory_uri() . '/assets/images/comment.svg' ?>" alt="icon commentary"
                class="comments-icon">
...
<section class="investigation"
  style="background: linear-gradient(0deg, rgba(64, 48, 61, 0.35), rgba(64, 48, 61, 0.35)), url(<?php echo get_the_post_thumbnail_url(); ?>) no-repeat center center">
  <div class="container">
  ...
  <div class="recently">
    <ul class="recently-left">
      ...
      $myposts = get_posts([ 
        'numberposts' => 6,
        'offset' => 1,
        'category_name'      => 'collections, hot, opinions, news',
      ]);
      ...
      <img class="recently-post-image" src="<?php echo get_the_post_thumbnail_url(); ?>" alt="">
      <div class="recently-post-wrapper">
      <?php the_category(); ?>
        <a class="recently-post-permalink" href="<?php get_the_permalink(); ?>"> 
          <h4 class="recently-post-title">
            <?php echo mb_strimwidth(get_the_title(), 0, 40, '...'); ?>
          </h4>
          <p class="recently-post-excerpt">
            <?php echo mb_strimwidth(get_the_excerpt(), 0, 150, '...'); ?>
          </p>
          </a>
          <div class="recently-post-bottom">
            <span class="date">
              <?php the_time('j F') ?>
            </span>
            <div class="comments">
